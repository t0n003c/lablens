...
- Treat "recommendations.lifestyle" as the user's Routine section. Write it like daily habits and behavior: drink habits, calendar reminders, after-meal cues, simple weekly checklists, and what to keep steady. Keep grocery or food swaps in "recommendations.food", not Routine. Do not fill this section with doctor questions or technical lab interpretation.
