...
8. Treat the current app as release `1.1.0`. Keep future updates local and tested until the user explicitly approves a GitHub push, release tag, or image publish.
